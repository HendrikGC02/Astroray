...
Generated 2026-09-19 07:12 UTC by `scripts/dev/known_issues_report.py` from GitHub issues labelled `addon-bug` / `addon-gap`. Do not edit by hand; file or close issues instead.
...
| [817](https://github.com/HendrikGC02/Astroray/issues/817) | P1-high | Viewport worker (pkg266): no presentation while orbiting the camera; refinement stuck at the reduced first-unit resolution | 2026-09-13 |
| [818](https://github.com/HendrikGC02/Astroray/issues/818) | P1-high | Procedural texture â†’ Math/Mix/Ramp chains flatten to a constant (op-VM accepts image-texture inputs only); coordinate-side Math/SeparateXYZ unsupported | 2026-09-13 |
