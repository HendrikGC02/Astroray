...
Generated 2026-09-07 23:18 UTC by `scripts/dev/known_issues_report.py` from GitHub issues labelled `addon-bug` / `addon-gap`. Do not edit by hand; file or close issues instead.
...
| [753](https://github.com/HendrikGC02/Astroray/issues/753) | P2-medium | Bump relief ~1.8-2x stronger than Cycles at equal Distance, with faint ring banding (pkg223b normal_mapped.cpp calibration) | 2026-09-07 |
