...
- **pkg55 Phase C is 5 of 7 sessions done/verified.** C1 (spectral-tables extraction, #481), C2 (MIS audit — no bug found, #484), C3 (non-visible-band + naive-MW wavefront, #486), C4 (TLAS/instancing + deformation motion, #490) are merged; **C5 (photon caustics, #494) is open-verified** (2/2 gates + 40-test regression green on RTX, not yet merged at closeout). Remaining: **C6 (ReSTIR reservoir SoA, GRIS-anchored)** and **C7 (2× end-to-end gate, then delete the megakernels LAST)**. Plan doc `.astroray_plan/docs/pkg55-phase-c-plan-2026-07.md` is authoritative.
