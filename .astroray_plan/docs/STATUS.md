...
**Owner decisions pending:** (1) pkg266 default flip of `ASTRORAY_VIEWPORT_WORKER` waits for the GUI Terra-4 Â§9 table (next session item 2). (2) pkg265 centre band 1.61Ã Cycles â #782 independent oracle decides. (3) pkg256 look: the bake has no sun disc and a warm Preetham horizon (see the contact sheet); accept as APPROXIMATED or prioritise #799.
