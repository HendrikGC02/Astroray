...
**Last updated:** 2026-06-12 evening (Stabilization + showcase + portability session — repo cleanup, full bells-and-whistles build in the MAIN checkout, full RTX sweep **1299 passed / 0 failed / 14 skipped / 21 xfailed / 3 xpassed** on b67b50f, perf gate re-confirmed **1.50×** cool, README showcase renders refreshed per owner feedback, 2026-06 HTML feature report, DEVELOPMENT.md portability doc, CUDA-arch portability fix for RTX 3000-series).
