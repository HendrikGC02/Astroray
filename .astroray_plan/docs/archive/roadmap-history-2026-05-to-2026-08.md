# ROADMAP history — 2026-05 to 2026-08 (archived 2026-09-07)

Moved out of `ROADMAP.md` during the 2026-09-07 course-correction: the Pillar-4 thaw notice (superseded by the 2026-06-08 pause and the 2026-09-07 exit gate), the backend-parity bridge narrative, and the inlined round-closeout logs (STATUS.md is the record of those). Kept verbatim for reference.
