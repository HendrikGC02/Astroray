...
**Status:** paused — Triage 2026-09-12 (half-implemented audit, `half-implemented-triage-2026-09-12.md`): light groups are Cycles parity (View Layer > Light Groups) — queue after the volumes track; pkg134 follows it. Was: still-open — never implemented; no light-group/emission-decomposition code in the repo, only the spec-filing PR #492.
