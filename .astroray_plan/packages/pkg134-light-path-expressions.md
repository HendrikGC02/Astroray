...
**Status:** paused — Triage 2026-09-12 (half-implemented audit, `half-implemented-triage-2026-09-12.md`): after pkg130. Was: still-open — never implemented; no LPE/light-path-expression automata in the repo, only the spec-filing PR #492.
