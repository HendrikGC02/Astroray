...
**Status:** done (PR #518, 2026-07-25 — un-xfailed 7/7 near-delta Disney-metal GPU/CPU parity rows, ratios 0.60–0.77 within the [0.4, 2.5] band; furnace 5/5; energy 271/271; wavefront_diff/perf/photon-caustic failures pre-existing on main, owned by pkg153; residual 1.3–1.7× GPU dimness tracked as follow-up pkg152). Full adjudication and hardware-verification detail retained below.
