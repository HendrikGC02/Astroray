...
**Status:** superseded — metal-dim symptom does not reproduce (pkg165); the rough-transmission furnace deficit is owned by pkg179 Part 2 (2026-09-07 backlog triage)
...
- 2026-09-07 backlog triage: status flipped to `superseded`. Previous status text: partially done (PR #523, merged 2026-07-25 — spectral eta² guard widened [THE #522 furnace blocker, verified 0.9987-1.0000 on-stack], mid/high-roughness metal compensation mirrored, clearcoat double-divide fixed; near-delta metal residual measured ~1.0 by verifier vs 0.60-0.77 in research doc — **reconciliation now owned by pkg158** (filed 2026-07-25, the split-out follow-up; its Step 0 is the scene-controlled re-measure of both setups — until it reports, neither number is citable)). **RECONCILED 2026-08-02 (pkg158 Step 0, PR #535): Outcome A** — the 0.60-0.77 Symptom-(a) near-delta table below is SUPERSEDED (it was carried forward from pkg141 post-#518, not re-measured on the #523 build); re-measured on one build b036ac93 the near-delta reads 0.924-0.949 linear with no near-delta cliff, confirming the #523 verifier's ~1.0. Only a uniform ~5-8% GPU-dim (within [0.90,1.10], not near-delta-specific) remains. No code.
