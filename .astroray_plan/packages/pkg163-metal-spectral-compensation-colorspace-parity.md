...
**Track:** A (RTX-gated)
**Status:** done (PR #533, 2026-08-02 — b036ac9. Direction A shipped: GPU metal builds its spectral response per-wavelength via `gpu_metal_eval_spectral`. pkg160's r=0.9 `[0.95,1.10]` band exception retired, standard `[0.95,1.05]` restored at all roughnesses (mean+median, 0.9: R/G/B 1.0153/1.0171/1.0112). Chromatic spread 0.0025 seed-averaged, 2560 spp x 4 seeds, vs <=0.01 bound; initial single-seed 256-spp HW run FAILED at 0.0133, diagnosed as MC noise in the statistic and re-run with the 4-seed-averaged statistic (bound unchanged) — PASS. 7/7 gates green on RTX 5070 Ti.)
