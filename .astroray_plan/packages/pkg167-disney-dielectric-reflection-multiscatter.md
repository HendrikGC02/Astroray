...
**Status:** open — dispatchable (prerequisite that pkg150's STOP fired for; pkg150 itself closes as resolved-by-pkg149 — charter met on main, only this multi-scatter gap remains)
