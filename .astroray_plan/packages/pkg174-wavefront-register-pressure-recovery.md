...
**Status:** in progress — dispatched 2026-08-07 (worktree .claude/worktrees/pkg174, branch pkg174-register-pressure); #541 precondition satisfied (merged 2026-08-06, bbf2d8c). This is the companion package that option A creates: #541 ships the correctness fix v4 with a TEMPORARY raise of the wavefront perf ceiling; this package restores the ceiling and reverts the raise.
