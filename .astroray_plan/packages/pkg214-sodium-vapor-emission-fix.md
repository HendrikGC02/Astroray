...
**Track:** A
**Status:** done (PR #632, 2026-08-22, supersedes #629). Energy-normalization refix after #629's peak-norm mercury regression: regenerated profiles.bin (all lamps Σ=1, every bin≤1), 28/28 tests, RENDER-VERIFIED on RTX (sodium amber (0.655,0.135,0.000) B1 PASS, mercury no regression). NOTE follow-up: mercury stored SPD is chromatically magenta not blue-green (546nm green under-weighted) — tracked in pkg218 thread A, separate from this emit-at-all fix.
