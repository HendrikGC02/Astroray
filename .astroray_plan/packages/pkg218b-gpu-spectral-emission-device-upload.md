...
> Renumbered **pkg218b** on 2026-09-07: filed as pkg218 on 2026-08-23 while `pkg218-spectral-colorimetry-fidelity.md` (2026-08-22) already held the number. Source comments citing `pkg218` in `src/gpu/*`, `src/emission_spectrum.cpp` and `tests/test_gpu_emission_colour_parity.py` refer to THIS package (device SPD upload), not to the colorimetry spec.
