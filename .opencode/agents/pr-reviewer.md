...
**Note (hybrid gate):** For non-HW-gated packages (Track A addon/orchestrator/
engine plumbing / docs-with-code), an independent Claude sign-off runs *before*
this checklist via the `sign-off` agent. That review is additive — it does not
