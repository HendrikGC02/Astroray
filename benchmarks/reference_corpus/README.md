...
| `textures_mapping` | 221 | 69 | 3 | 72 | 0 | 149 |
...
`coverage_matrix.json` changes -- these totals will drift with it, most
likely downward once pkg260's scanner extension lands.)
