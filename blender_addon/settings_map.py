...
_CAMERA = [
    ...
    MappingEntry("camera", "type", "camera.data.type", "",
                 "setup_camera(orthographic)", "approximated", "APPROXIMATED",
                 "#845: PERSP and ORTHO native; PANO falls back to perspective (reported)."),
    ...
    MappingEntry("camera", "ortho_scale", "camera.data.ortho_scale", "",
                 "setup_camera(ortho_width/height)", "direct", "SUPPORTED",
                 "#845: resolved to plane extents via sensor_fit; shift in ortho_scale units."),
