...
-----
    ...
    python scripts/build/build_blender_addon.py --blender "<path>"       # target a specific Blender
    python scripts/build/build_blender_addon.py --python-exe C:/Python313/python.exe
    python scripts/build/build_blender_addon.py --install                # also copy into
                                                                   # Blender's extensions dir
    python scripts/build/build_blender_addon.py --clean                  # wipe build dir first
