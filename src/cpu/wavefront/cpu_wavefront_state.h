// pkg55 Phase B' Session 2c/3/4 — CPU wavefront SoA state layout.
//
...
//
// This is the CPU mirror of Phase A.1's GPU `IntegratorStateSoA`. Session 4
// scope is Lambertian + metal + dielectric + area lights (growing oracle).
//
// Session 2c/3/4 — the SoA is a pure CARRIER for the shared kernel's PathState
