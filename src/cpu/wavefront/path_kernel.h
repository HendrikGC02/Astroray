// pkg55 Phase B' Session 2c/3 — Shared per-bounce path kernel.
//
// Spec: .astroray_plan/packages/pkg55-wavefront-soa-refactor.md §"Sessions 2c/3".
...
// arithmetic sequence (intersect -> shade(Lambertian/metal) -> NEE -> RR ->
